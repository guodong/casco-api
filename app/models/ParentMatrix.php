...
class ParentMatrix extends BaseModel {
	...
	,'Completeness','No Compliance Description','Defect Type','Verif. Assesst','Verif Assest justifiaction','CR','Comment','column','parent_v_id','verification_id','updated_at','created_at');
