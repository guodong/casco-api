...
CREATE TABLE `rs` (
  ...
  `vat` varchar(255) NOT NULL COMMENT 'vat分配到其他部分，类似备注',
  `source_id` int(11) NOT NULL,
  `created_at` datetime NOT NULL,
  `updated_at` datetime NOT NULL,
  PRIMARY KEY (`id`),
...
INSERT INTO `rs` VALUES ('28b38466-a6c0-11e4-b3f2-2eb1ec8cf52b','1','132313','3123','32','High','33','12','321','123',0,'0000-00-00 00:00:00','2015-02-02 06:44:46'),('9123ffb2-a6c5-11e4-b3f2-2eb1ec8cf52b','1','[TSP-SyRS-0001]','Trackside safety product shall consist of TSP and application software (APP).\r\nTrackside safety product shall consist of TSP and application software (APP).\r\n轨旁安全产品由TSP和应用软件（APP）组成。\r\n',' 1.1.0','',' SIL0',' Functional',' [TSP-SyAD]\r\n','f',0,'2014-12-09 03:50:31','2015-02-02 06:44:57');
...
INSERT INTO `tc` VALUES ('399b97e7-776f-49f3-b4fe-ffc218f0ff55','5','[TSP-SyRTC-0117]','Check TSP shall be a hot-redundant 2×2oo2 system.','EP','APP installed on A MPU1 and A MPU2 is the same as B MPU1 and B MPU2. ',0,'2015-01-28 08:22:08','2015-02-02 04:12:38'),('fd7bdad4-c56c-410c-95b6-910e53f1dd6b','5','[TSP-SyRTC-0117]','Check TSP shall be a hot-redundant 2×2oo2 system.','EP','APP installed on A MPU1 and A MPU2 is the same as B MPU1 and B MPU2. ',0,'2015-01-28 08:23:47','2015-01-28 08:23:47'),('01e87349-d3b1-4985-b261-2de78719a825','5','1','1','EP','1',0,'2015-01-29 05:55:57','2015-01-29 05:55:57'),('2e47eb3e-3582-49f8-9cf0-40a554841e7d','5','2','2','EP','2',0,'2015-01-29 05:58:34','2015-01-29 05:58:34'),('87e9f18a-9801-4353-99c8-66090109f093','5','1','1','EG','1',0,'2015-01-29 08:37:51','2015-02-02 03:35:34'),('7276c180-fd88-4d36-a9b6-724ea6efbd28','','1','1','EP','1',0,'2015-01-30 05:37:24','2015-01-30 05:37:24'),('996417bd-d5d9-4d8d-9e72-8283feb39a8f','5','1','1','EP','1',0,'2015-01-30 05:40:31','2015-01-30 05:40:31'),('bf9839fe-31e2-495a-bf51-116ad2364c64','5','13333245','1','EP','132',1,'2015-01-30 06:04:40','2015-02-02 04:54:36');
...
INSERT INTO `tc_source` VALUES ('2e47eb3e-3582-49f8-9cf0-40a554841e7d','9123ffb2-a6c5-11e4-b3f2-2eb1ec8cf52b'),('',''),('89cddcf6-eba7-42ce-a6f6-316dc51e9aa4','9123ffb2-a6c5-11e4-b3f2-2eb1ec8cf52b'),('2bd7c67e-deb9-4ee6-8ded-321afe0ba38b','9123ffb2-a6c5-11e4-b3f2-2eb1ec8cf52b'),('',''),('7276c180-fd88-4d36-a9b6-724ea6efbd28','9123ffb2-a6c5-11e4-b3f2-2eb1ec8cf52b'),('fd7bdad4-c56c-410c-95b6-910e53f1dd6b','28b38466-a6c0-11e4-b3f2-2eb1ec8cf52b'),('fd7bdad4-c56c-410c-95b6-910e53f1dd6b','9123ffb2-a6c5-11e4-b3f2-2eb1ec8cf52b'),('01e87349-d3b1-4985-b261-2de78719a825','28b38466-a6c0-11e4-b3f2-2eb1ec8cf52b'),('996417bd-d5d9-4d8d-9e72-8283feb39a8f','9123ffb2-a6c5-11e4-b3f2-2eb1ec8cf52b'),('87e9f18a-9801-4353-99c8-66090109f093','9123ffb2-a6c5-11e4-b3f2-2eb1ec8cf52b'),('399b97e7-776f-49f3-b4fe-ffc218f0ff55','28b38466-a6c0-11e4-b3f2-2eb1ec8cf52b'),('bf9839fe-31e2-495a-bf51-116ad2364c64','9123ffb2-a6c5-11e4-b3f2-2eb1ec8cf52b');
...
INSERT INTO `tc_step` VALUES ('87e9f18a-9801-4353-99c8-66090109f093',3,'4','4','2015-02-02 03:35:34','2015-02-02 03:35:34'),('87e9f18a-9801-4353-99c8-66090109f093',2,'3','3','2015-02-02 03:35:34','2015-02-02 03:35:34'),('87e9f18a-9801-4353-99c8-66090109f093',1,'1','1','2015-02-02 03:35:34','2015-02-02 03:35:34'),('7276c180-fd88-4d36-a9b6-724ea6efbd28',1,'1','1','2015-01-30 05:37:24','2015-01-30 05:37:24'),('7276c180-fd88-4d36-a9b6-724ea6efbd28',2,'3','3','2015-01-30 05:37:24','2015-01-30 05:37:24'),('7276c180-fd88-4d36-a9b6-724ea6efbd28',3,'4','4','2015-01-30 05:37:24','2015-01-30 05:37:24'),('996417bd-d5d9-4d8d-9e72-8283feb39a8f',3,'4','4','2015-01-30 08:57:00','2015-01-30 08:57:00'),('996417bd-d5d9-4d8d-9e72-8283feb39a8f',2,'3','3','2015-01-30 08:57:00','2015-01-30 08:57:00'),('996417bd-d5d9-4d8d-9e72-8283feb39a8f',1,'1','1','2015-01-30 08:57:00','2015-01-30 08:57:00'),('01e87349-d3b1-4985-b261-2de78719a825',1,'1','11','2015-01-30 08:52:53','2015-01-30 08:52:53'),('bf9839fe-31e2-495a-bf51-116ad2364c64',2,'33','22','2015-02-02 04:54:36','2015-02-02 04:54:36'),('fd7bdad4-c56c-410c-95b6-910e53f1dd6b',1,'4','4','2015-01-30 07:59:11','2015-01-30 07:59:11'),('399b97e7-776f-49f3-b4fe-ffc218f0ff55',1,'2','3','2015-02-02 04:12:38','2015-02-02 04:12:38'),('399b97e7-776f-49f3-b4fe-ffc218f0ff55',2,'3','3323','2015-02-02 04:12:38','2015-02-02 04:12:38'),('bf9839fe-31e2-495a-bf51-116ad2364c64',1,'3','3','2015-02-02 04:54:36','2015-02-02 04:54:36'),('399b97e7-776f-49f3-b4fe-ffc218f0ff55',3,'123','3213微软','2015-02-02 04:12:38','2015-02-02 04:12:38');
...
-- Dump completed on 2015-02-02 15:18:29
